						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<select name="card_id" id="card_id" class="form-control">
									...
									<option value="<?php echo $item['card_id']?>" <?php echo !empty($olddata['card_id']) && $olddata['card_id'] == $item['card_id'] ? 'selected' : '' ?>><?php echo $item['card_name']?></option>
									<?php }?>
								</select>
							</div>
							<div class="form-group">
								...
								<select name="post_id" id="post_id" class="form-control">
									...
									<option value="<?php echo $item['post_id']?>" <?php echo !empty($olddata['post_id']) && $olddata['post_id'] == $item['post_id'] ? 'selected' : '' ?>><?php echo $item['name']?></option>
									<?php }?>
								</select>
							</div>
							<div class="form-group">
								...
								<select name="status" id="status" class="form-control">
									...
									<option value="<?php echo $v?>" <?php echo !empty($olddata['status']) && $olddata['status'] == $item['status'] ? 'selected' : '' ?>><?php echo $v?></option>
									<?php }?>
								</select>
							</div>
							<div class="form-group">
