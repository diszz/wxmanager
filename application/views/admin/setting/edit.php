					...
					<div class="panel-body">
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="key" name="key" value="<?php echo !empty($info['key']) ? $info['key'] : '' ?>">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="value" name="value" value="<?php echo !empty($info['value']) ? $info['value'] : '' ?>">
							</div>
						</div>
					</div>
				</div>
