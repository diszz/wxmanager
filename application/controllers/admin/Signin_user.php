 ...
 *
 */
class Signin_user extends MY_Controller
{
	public function __construct()
	{
		parent::__construct();
		
		$this->load->model(array("signin_user_model", 'signin_model'));
	}
	...
	public function index($cur_signin = 0, $offset = 0)
	{
		...
		$list = $this->signin_user_model->getList($params, null, $offset, $limit);
		$count = $this->signin_user_model->getCount($params);
		...
		return $this->load->view('admin/signin_user/index', array(
				'list' => $list,
				'count' => $count,
