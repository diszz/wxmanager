				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<fieldset>
                            ...
                            <div class="form-group">
								<div class="col-md-6">
	                            	<label for="level">关键词栏</label>
	                            	<select id="level" name="excel_name" class="form-control">
                            ...
                            <div class="form-group">
								<div class="col-md-6">
	                            	<label for="answer1">选项开始栏</label>
	                            	<select id="answer1" name="excel_children_start" class="form-control">
	                            		<option value="0">A</option>
	                            		<option value="1">B</option>
	                            		<option value="2">C</option>
	                            		<option value="3">D</option>
