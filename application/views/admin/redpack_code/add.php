						...
						<div class="col-md-8">
							<div class="form-group">
								...
								<select name="redpack_id" class="form-control">
									...
									<option value="<?php echo $item['redpack_id']?>"><?php echo $item['name']?></option>
									<?php }?>
								</select>
							</div>
							<div class="form-group">
								<label class="control-label" for="content">活动码</label>
								<textarea class="form-control" id="content" name="content" ><?php echo !empty($olddata['content']) ? $olddata['content'] : $key ?></textarea>
							</div>
							<div class="form-group">
								<label class="control-label" for="money">金额, 单位为分</label>
								<textarea class="form-control" id="money" name="money" ><?php echo !empty($olddata['money']) ? $olddata['money'] : '100' ?></textarea>
							</div>
						</div>
					</div>
				</div>
