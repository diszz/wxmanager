					...
					<div class="panel-body">
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="title" name="title" value="<?php echo !empty($olddata['title']) ? $olddata['title'] : '' ?>">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<textarea class="form-control" id="desc" name="desc" ><?php echo !empty($olddata['desc']) ? $olddata['desc'] : '' ?></textarea>
							</div>
							<div class="form-group">
								<label class="control-label" for="icon">图片</label>
								<input type="text" class="form-control" id="icon" name="icon" value="<?php echo !empty($olddata['icon']) ? $olddata['icon'] : '' ?>">
							</div>
							<div class="form-group">
								<label class="control-label" for="url">地址</label>
								<input type="text" class="form-control" id="url" name="url" value="<?php echo !empty($olddata['url']) ? $olddata['url'] : '' ?>">
								<div class="checkbox">
								<label>
									<input type="checkbox" id="is_redirect" name="is_redirect" value="1" <?php echo !empty($olddata['is_redirect']) ? 'checked' : '' ?>>跳转地址
								</label>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<textarea class="form-control" id="share_desc" name="share_desc" ><?php echo !empty($olddata['share_desc']) ? $olddata['share_desc'] : '' ?></textarea>
							</div>
						</div>
					</div>
				</div>
